...
public class OrderDetailSample extends DemoApplicationTests {
    ...
    private void item(User user){
        ...
        switch (s){
            ...
            case 3 :
                status = OrderStatus.DELIVERY_ING;
        ...
        for(Item item : items){
            ...
            OrderStatus orderDetailStatus = OrderStatus.FAIL;
            switch (random.nextInt(3)+1){
                case 1 :
                    orderDetailStatus = OrderStatus.PAYMENT;
                    break;

                case 2 :
                    orderDetailStatus = OrderStatus.DELIVERY_REQUEST;
                    break;

                case 3 :
                    orderDetailStatus = OrderStatus.DELIVERY_ING;
                    break;
            }
